...
| NFR-004 | Disk | Content Store growth is bounded: at most [CFG-005] distinct payloads per recrawl generation, with at most ceil([CFG-027] × 86400 / [CFG-025]) generations retained when recrawl is enabled ([CFG-025]>0; [CFG-027] is days, [CFG-025] seconds — the formula converts to seconds before dividing), else one; the retention job enforces [DOC-11 §6]. |
